...
namespace WinAppAlgoritmos
{
    internal class CBresenham
    {
        ...
        // Calcula todos los puntos usando el algoritmo de Bresenham
        public void CalculateBresenham(PictureBox picCanvas)
        {
            mLinePoints.Clear();
            ...
            int err = dx - dy;
            P_Inicial = 2 * dy - dx; // Parámetro de decisión inicial
